...
_LEITURA_CLINICA_TXT = (
    ...
    f"elevado em maior número de combinações entre segmentos e direções, além de maior "
    f"variabilidade nos três eixos do joelho (vertical, anteroposterior e médio-lateral). "
